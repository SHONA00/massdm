...
9XXb._       _.dXXXXb dXXXXbo.                 .odXXXXb dXXXXb._       _.dXXP
 9XXXXXXXXXXXXXXXXXXXVXXXXXXXXOo.           .oOXXXXXXXXVXXXXXXXXXXXXXXXXXXXP
  `9XXXXXXXXXXXXXXXXXXXXX'~   ~`OOO8b   d8OOO'~   ~`XXXXXXXXXXXXXXXXXXXXXP'
    `9XXXXXXXXXXXP' `9XX'  {Fore.WHITE}BLACK{Fore.GREEN}{Style.BRIGHT}{Fore.GREEN}{Style.BRIGHT}   `98v8P' {Fore.WHITE}KILLERS{Fore.GREEN}{Style.BRIGHT} `XXP' `9XXXXXXXXXXXP'
        ~~~~~~~       9X.          .db|db.          .XP       ~~~~~~~
          ...
          {Fore.WHITE}MASS{Fore.GREEN}{Style.BRIGHT}        dXXXXXXXXXXXP'   .   `9XXXXXXXXXXXb        {Fore.WHITE}BY{Fore.GREEN}{Style.BRIGHT} 
                    ...
                    9XXb'   `XXXXXb.dX|Xb.dXXXXX'   `dXXP
                     `'      9XXXXXX(   )XXXXXXP      `'
          {Fore.WHITE}DM{Fore.GREEN}{Style.BRIGHT}                   XXXX X.`v'.X XXXX                 {Fore.WHITE}SHONA{Fore.GREEN}{Style.BRIGHT} 
                              XP^X'`b   d'`X^XX
                              X. 9  `   '  P )X
                              `b  `       '  d' 
